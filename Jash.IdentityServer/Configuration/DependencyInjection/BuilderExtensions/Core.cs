...
using Jash.IdentityServer.Stores.Serialization;
...
using static Jash.IdentityServer.IdentityServerConstants;
using Jash.IdentityServer.Extensions;
using Jash.IdentityServer.Hosting.FederatedSignOut;
using Jash.IdentityServer.Services.Default;
using Jash.IdentityServer.Services.KeyManagement;
using Microsoft.Extensions.Logging;
using Jash.IdentityServer.Hosting.DynamicProviders;
using Jash.IdentityServer.Internal;
using Jash.IdentityServer.Stores.Empty;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where TEndpoint : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new Jash.IdentityServer.Hosting.Endpoint(name, path, typeof(TEndpoint)));
