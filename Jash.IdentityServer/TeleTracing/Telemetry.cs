...
public static class Telemetry
{
    ...
    /// <summary>
    /// Service name used for Jash IdentityServer.
    /// </summary>
    public const string ServiceName = "Jash.IdentityServer";

    /// <summary>
    /// Service name used for the experimental non stable counters from Jash IdentityServer
    /// </summary>
    public const string ServiceNameExperimental = "Jash.IdentityServer.Experimental";
