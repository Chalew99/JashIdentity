...
public static class IdentityServerConstants
{
    ...
    //{
    //    public static readonly string Basic = Jash.IdentityServer.Tracing.TraceNames.Basic;
    //    public static readonly string Stores = Jash.IdentityServer.Tracing.TraceNames.Store;
    //    public static readonly string Cache = Jash.IdentityServer.Tracing.TraceNames.Cache;
    //    public static readonly string Validation = Jash.IdentityServer.Tracing.TraceNames.Validation;
    //    public static readonly string Services = Jash.IdentityServer.Tracing.TraceNames.Services;

    //    public static readonly string ServiceVersion = Jash.IdentityServer.Tracing.ServiceVersion;
    //}
