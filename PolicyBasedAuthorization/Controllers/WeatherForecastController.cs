...
namespace PolicyBasedAuthorization.Controllers
{
	...
	public class WeatherForecastController : ControllerBase
	{
        ...
        [SwaggerOperation(Summary = "This endpoint only allows users older than 16years")]
        public IActionResult Get_Sample06()
        {
            return Ok();
        }
	    ...
	    [SwaggerOperation(Summary = "This endpoint only allows Administrators using Role based access")]
