...
namespace PolicyBasedAuthorization.Services
{
	...
	public class UserService : IUserService
	{
        ...
        {
            _users.Add(new BasicUser { UserId = 1, UserName = "admin", Password = "password123", DateofBirth = DateTime.Parse("1982-01-01"), Roles = new[] { Roles.Administration } });
            _users.Add(new BasicUser { UserId = 2, UserName = "standard", Password = "password123", DateofBirth = DateTime.Parse("2013-01-01") });
        }
