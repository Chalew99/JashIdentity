...
using Jash.IdentityServer.EntityFramework.Interfaces;
...
namespace Jash.IdentityServer.EntityFramework.Stores;

/// <summary>
/// Implementation of IPersistedGrantStore thats uses EF.
/// </summary>
/// <seealso cref="IPersistedGrantStore" />
public class PersistedGrantStore : Jash.IdentityServer.Stores.IPersistedGrantStore
{
    /// <summary>
    /// The DbContext.
    /// </summary>
    ...
    /// <inheritdoc/>
    public virtual async Task StoreAsync(Jash.IdentityServer.Models.PersistedGrant token)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<Jash.IdentityServer.Models.PersistedGrant> GetAsync(string key)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IEnumerable<Jash.IdentityServer.Models.PersistedGrant>> GetAllAsync(PersistedGrantFilter filter)
    {
