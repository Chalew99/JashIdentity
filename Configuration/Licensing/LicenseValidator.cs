...
// shared APIs needed for Jash license validation
    ...
    where T : License, new()
{
    ...
    {
        "Jash_License.key",
        "Jash_IdentityServer_License.key",
    };
    ...
    {
        Logger = loggerFactory.CreateLogger($"Jash.{productName}.License");
    ...
    protected void ValidateLicense()
    {
        if (License == null)
        {
            var message = "You do not have a valid license key for the Jash software. " +
                          ...
                          "Please start a conversation with us: https://Jashsoftware.com/contact";
        ...
        DebugLog.Invoke("The Jash license key details: {@license}", new[] { License });
        ...
        if (errors.Count > 0)
        {
            ...
            ErrorLog.Invoke(
                "Please contact {licenseContact} from {licenseCompany} to obtain a valid license for the Jash software.",
        ...
        else
        {
            ...
            {
                InformationLog.Invoke("You have a valid license key for the Jash software {edition} edition for use at {licenseCompany}. The license expires on {licenseExpiration}.",
                    new object[] { License.Edition, License.CompanyName, License.Expiration.Value.ToLongDateString() });
            }
            else
            {
                InformationLog.Invoke(
                    "You have a valid license key for the Jash software {edition} edition for use at {licenseCompany}.",
    ...
    protected virtual void ValidateExpiration(List<string> errors)
    {
        if (License.Expiration.HasValue)
        {
            ...
            if (diff > 0)
            {
                errors.Add($"Your license for the Jash software expired {diff} days ago.");
            }
        }
    }
    ...
    internal T ValidateKey(string licenseKey)
    {
        if (!String.IsNullOrWhiteSpace(licenseKey))
        {
            ...
            {
                ValidIssuer = "https://Jashsoftware.com",
            ...
            {
                Logger.LogCritical(validateResult.Exception, "Error validating the Jash software license key");
            }
        }
