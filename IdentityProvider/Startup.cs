...
namespace IdentityProvider
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            const string connectionString = "data source=.;initial catalog=IdentityServerStorageDB3;User=Realworld;Password=c0nduit@R3alw0rld;TrustServerCertificate=True";
